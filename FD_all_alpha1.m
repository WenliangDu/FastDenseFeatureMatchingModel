...
%% FD feature matching
t1 = clock;
[indexPairsPar,RecordIndiesNew,tform1,tform2,IndicesInitialRANSAC,indexPairsInitialRANSAC,inliersInitialRANSAC,GoodClassidx,SearchingRange,RealSearchingRange] =ParFeatureMatching_alpha7(features1,features2,validBlobs1,validBlobs2,I1,I2);
...
inliersPar = ParFeatureMatching_RemoveOutliers_alpha2_1(Location1,Location2,indexPairsPar,RecordIndiesNew,method);
t2 = clock;
